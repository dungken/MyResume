 ...
 */
import { combineReducers } from 'redux' // lưu ý có sẵn redux trong node_modules bởi vì khi cài @reduxjs/toolkit là đã có luôn
import { persistReducer } from 'redux-persist'
import storage from 'redux-persist/lib/storage' // default là localstorage

// Cấu hình persist
const rootPersistConfig = {
  key: 'root', // key của cái persist do chỉ định, cứ để mặc định là root
...
// Combine các reducers trong dự án của ở đây
