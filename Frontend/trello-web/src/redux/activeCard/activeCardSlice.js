...
export const activeCardSlice = createSlice({
  ...
  reducers: {
    ...
    updateCurrentActiveCard: (state, action) => {
      const fullCard = action.payload // action.payload là chuẩn đặt tên nhận dữ liệu vào reducer, ở đây gán nó ra một biến có nghĩa hơn
...
// Cái file này tên là activeCardSlice NHƯNG sẽ export một thứ tên là Reducer, mọi người lưu ý :D
