...
// withCredentials: Sẽ cho phép axios tự động gửi cookie trong mỗi request lên BE (phục vụ việc sẽ lưu JWT tokens (refresh & access) vào trong httpOnly Cookie của trình duyệt)
...
authorizedAxiosInstance.interceptors.response.use((response) => {
  ...
  if (error.response?.status === 410 && originalRequests) {
    // UPDATE THÊM: Có thể bỏ không cần thêm cái _retry giống như nhiều bài hướng dẫn khác trên mạng nữa vì đang làm chuẩn với biến refreshTokenPromise ở trên rồi, nếu muốn hiểu rõ hơn thì có thể xem riêng phần này ở bộ JWT trên kênh của mình , Link: https://www.youtube.com/playlist?list=PLP6tw4Zpj-RJwtNw9564QKFf93hWiDnR_
    ...
    return refreshTokenPromise.then(accessToken => {
      ...
      */
      ...
      // Case 2: Bước Quan trọng: Return lại axios instance của kết hợp các originalRequests để gọi lại những api ban đầu bị lỗi
