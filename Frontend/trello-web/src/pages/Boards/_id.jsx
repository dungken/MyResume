...
function Board() {
  ...
  const moveColumns = (dndOrderedColumns) => {
    ...
    /**
    * Trường hợp dùng Spread Operator này thì lại không sao bởi vì ở đây không dùng push như ở trên làm thay đổi trực tiếp kiểu mở rộng mảng, mà chỉ đang gán lại toàn bộ giá trị columns và columnOrderIds bằng 2 mảng mới. Tương tự như cách làm concat ở trường hợp createNewColumn thôi :))
    */
