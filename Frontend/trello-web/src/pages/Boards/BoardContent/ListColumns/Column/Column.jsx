...
function Column({ column }) {
  ...
  const dndKitColumnStyles = {
    ...
    transition,
    // Chiều cao phải luôn max 100% vì nếu không sẽ lỗi lúc kéo column ngắn qua một cái column dài thì phải kéo ở khu vực giữa giữa rất khó chị. Lưu ý lúc này phải kết hợp với {...listeners} nằm ở Box chứ không phải ở div ngoài cùng để tránh trường hợp kéo vào vùng xanh.
    height: '100%',
  ...
  const handleDeleteColumn = () => {
    confirmDeleteColumn({
      ...
      // description: 'Phải nhập chữ dungken thì mới được Confirm =))',
      // confirmationKeyword: 'dungken'
    }).then(() => {
